...
export const KingdomIcon = ({ size = 24 }: KingdomProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <rect width={size} height={size} fill="url(#kingdomPattern)" />
    <defs>
      <pattern id="kingdomPattern" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlinkHref="#kingdomImage" transform="scale(0.0138889)" />
      </pattern>
      <image
        id="kingdomImage"
        width="72"

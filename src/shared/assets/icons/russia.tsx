...
export const RussiaIcon = ({ size = 24 }: RussiaProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <rect width={size} height={size} fill="url(#russiaPattern)" />
    <defs>
      <pattern id="russiaPattern" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlinkHref="#russiaImage" transform="scale(0.0138889)" />
      </pattern>
      <image
        id="russiaImage"
        width="72"
